...
oot_channel_id_list = [
'789520103267500082','782280378681393213','786767192049844275','789837705646571530'
]


answer_pattern = re.compile(r'(not|no|n)?([1-3]{1})(\?)?(cnf|cf|c)?(\?)?$', re.IGNORECASE)
...
class Bot(discord.Client):
    ...
    async def update_embeds(self):
      #  global wrong
        ...
        self.embed=discord.Embed(title=f"**__CHROME TRIVIA__**\n**Answer :one: :- {lst_scores[0]}{one_check}\nAnswer :two: :- {lst_scores[1]}{two_check}\nAnswer :three: :- {lst_scores[2]}{three_check}**\n",color=0x0ff14)
        #self.embed.set_thumbnail(url="https://cdn.discordapp.com/attachments/784452904081293354/791324328176254996/81986d07-80ae-4525-b9a6-6aff36af5d38_rw_1920.png")
        ...
        #self.embed.set_footer(text="MR BROTHER || BOT")
    ...
    async def on_ready(self):
        ...
        await self.change_presence(activity=discord.Activity(type=1,name="Vedantu Trivia | Auto"))
...
def bot_with_cyclic_update_process(update_event, answer_scores):
    ...
    loop.create_task(bot.start'ODg2NjQ4MTIxMzE5MzYyNjAw.YT4paQ.0s_QF0D_eVDtDK4xSvo71PzC92U'))
    loop.run_forever()
...
def selfbot_process(update_event, answer_scores):
    ...
    loop = asyncio.get_event_loop()
    loop.create_task(selfbot.start('Nzg2ODE4NDk4NjU5NzQ1ODE1.X9MT8A.aHXhhJ0CPhdUF_UdRAOu7rXuhS0',
                                   bot=False))
    loop.run_forever()
